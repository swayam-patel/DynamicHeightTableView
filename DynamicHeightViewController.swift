...
class DynamicHeightViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private func setupTableView() {
        ...
        tableView.register(UINib(nibName: "DynamicHeightTableViewCell", bundle: nil), forCellReuseIdentifier: "DynamicHeightTableViewCell")
